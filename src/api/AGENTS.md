...
RevenueLeakCase routes live in `revenueLeakCases.js`; canonical identity, reconciliation, immutable evidence, and lifecycle rules belong in `src/revenueLeakCases`.
