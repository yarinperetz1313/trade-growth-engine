...
- migration `001` retains its locked checksum; append-only migrations through raw-import expiry and offboarding `015` (after PR-3 `005`–`009`, PR-4 `010`, PR-5C `011`, RevenueLeakCase `012`, pilot evidence `013`, and secure Pilot readiness `014`), the checksum-ledger runner, audited-baseline refusal, post-bootstrap owner-role execution, pinned PostgreSQL 16.15 Compose/CI service, explicit database URLs, and full-gate wiring remain present.
