...
- **PR-3 and PR-4 are integrated and verified at `9fe7cea`**: tenant-aware PostgreSQL repositories and transactional RevenueAction persistence consume the membership-derived auth boundary through a server-only trusted-context bridge. [GitHub Actions Verify run 33493292854](https://github.com/yarinperetz1313/trade-growth-engine/actions/runs/33493292854) passed the complete combined gate. Real Auth0 AU/SMTP acceptance remains deployment-gated; PR-5 and later product work remain not started.
