...
- **PR-2 is next and not started**: tenant-scoped transactional production persistence remains future work, gated by the unresolved vendor/provisioning decisions in the active plan.
