...
- [`active/pilot-readiness.md`](active/pilot-readiness.md) — **PR-0 through PR-2 are COMPLETE. PR-3 is unavailable/not implemented. PR-4 code is implemented pending final CI/review evidence.**
