...
- [`active/pilot-readiness.md`](active/pilot-readiness.md) — **PR-0 through PR-2 are COMPLETE. PR-3 and PR-4 are integrated in code; combined final CI/review evidence remains pending.**
