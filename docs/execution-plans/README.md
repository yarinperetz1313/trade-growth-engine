...
- [`active/revenue-leak-case-foundation.md`](active/revenue-leak-case-foundation.md) — **Issue #8 RevenueLeakCase foundation is in progress; detector/UI/recovery/attribution consumers remain out of scope.**
