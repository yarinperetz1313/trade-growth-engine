...
test("secure readiness requires the exact migration marker, runtime role, and membership lookup", async () => {
  ...
  for (const readinessRow of [
    ...
    { schema_version: "016", runtime_role_member: false, login_nonprivileged: true, required_relations_available: true },
    { schema_version: "016", runtime_role_member: true, login_nonprivileged: false, required_relations_available: true },
    { schema_version: "016", runtime_role_member: true, login_nonprivileged: true, required_relations_available: false }
  ]) {
