...
test("engineering harness gate rejects removal of every Pilot Readiness contract rule", () => {
  const contractRemovals = [
    ...
    {
      relativePath: "docs/execution-plans/README.md",
      expected: "PR-3 is unavailable/not implemented",
      error: /Execution-plan index must mark Pilot PR-3 unavailable and not implemented/
    },
    {
    ...
    {
      relativePath: "docs/execution-plans/active/pilot-readiness.md",
      expected: "PR-3 — unavailable/not implemented",
      error: /Pilot plan must mark PR-3 unavailable and not implemented/
    },
    {
      relativePath: "docs/execution-plans/active/pilot-readiness.md",
      expected: "PR-4 — code and deterministic contracts implemented",
      error: /Pilot plan must mark PR-4 code implemented/
    },
    {
    ...
    {
      relativePath: "database/migrations/005_auth_membership_and_invitations.sql",
      expected: "create function tge.consume_assisted_invitation",
      error: /Migration 005 must provide atomic invitation consumption/
    }
  ];
